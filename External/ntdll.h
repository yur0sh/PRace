...
typedef struct _PEB_LDR_DATA32
{
	...
	BOOLEAN			Initialized;
	ULONG			SsHandle;
	LIST_ENTRY32	InLoadOrderModuleList; // ref. to PLDR_DATA_TABLE_ENTRY->InLoadOrderModuleList
	LIST_ENTRY32	InMemoryOrderModuleList; // ref. to PLDR_DATA_TABLE_ENTRY->InMemoryOrderModuleList
	LIST_ENTRY32	InInitializationOrderModuleList; // ref. to PLDR_DATA_TABLE_ENTRY->InInitializationOrderModuleList
...
typedef struct _PEB64
{
	...
	ULONG64				Mutant;								// 4
	ULONG64				ImageBaseAddress;					// 8
	ULONG64				Ldr;								// C
	ULONG64				ProcessParameters;					// 10
...
{
	ULONG_PTR		liKernelTime;       // 100 nsec units
	ULONG_PTR		liUserTime;         // 100 nsec units
	ULONG_PTR		liCreateTime;       // relative to 01-01-1601
...
{
	PPEB32	Wow64PebBaseAddress;
} PROCESS_WOW64_INFORMATION, *PPROCESS_WOW64_INFORMATION;
...
#define	LPC_MAX_MESSAGE_SIZE	0x148		// bytes
#define	LPC_MAX_DATA_SIZE		0x104		// 
...
#define _CONTEXT_i386			0x010000   
#define _CONTEXT_AMD64			0x100000
#define	_CONTEXT_CONTROL		1
#define	_CONTEXT_INTEGER		2
